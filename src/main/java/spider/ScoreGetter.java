...
public static String get(String username, String password, HttpClient client) throws IOException {
   if (scoreGetter == null) scoreGetter = new ScoreGetter();
   return scoreGetter.getScore(username, password, client);
}

public static void main(String[] args) throws IOException {
   System.out.println(ScoreGetter.get("xxx", "xxxx", HttpClients.createDefault()));
}
}
